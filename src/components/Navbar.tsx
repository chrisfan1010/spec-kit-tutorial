        ...
        <div className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="text-[#8B949E] hover:text-[#F97316] transition-colors text-sm"
            >
              {link.label}
            </a>
          ))}
          <a
            ...
            target="_blank"
            rel="noopener"
            className="flex items-center gap-2 text-[#8B949E] hover:text-[#F97316] transition-colors text-sm"
          >
